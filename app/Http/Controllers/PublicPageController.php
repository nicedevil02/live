    ...
    public function guideShow(string $slug)
    {
        $guides = [
            'gold-price-formula-18k' => [
                'title' => 'فرمول دقیق محاسبه قیمت طلا ۱۸ عیار با اجرت و سود اتحادیه در طلا فروشی',
                'description' => 'آموزش گام‌به‌گام نحوه محاسبه فاکتور طلا، درصد اجرت، سود ۷ درصد قانونی مغازه طلا فروشی و قانون جدید مالیات بر ارزش افزوده در سال ۱۴۰۴.',
                'date' => '۱۴۰۴/۰۶/۲۰',
            ...
            'how-to-calculate-coin-bubble' => [
                ...
                'description' => 'نحوه استخراج ارزش ذاتی سکه تمام، نیم سکه، نیم‌سکه، ربع سکه و ربع‌سکه بر اساس وزن، عیار ۹۰۰ و حق ضرب بانک مرکزی، و فرمول تفکیک حباب مثبت و منفی.',
                'date' => '۱۴۰۴/۰۶/۱۲',
