...
@section('meta_description', 'محاسبه آنلاین و دقیق قیمت طلا در طلا فروشی بر اساس آخرین فرمول مصوب اتحادیه طلا و قانون جدید مالیات. محاسبه آنی حباب سکه امامی، بهار، نیم‌سکه و ربع‌سکه با نرخ زنده طلالایو.')
@section('meta_keywords', 'ماشین حساب طلا, ماشین‌حساب طلا, محاسبه قیمت طلا در طلا فروشی, فرمول محاسبه قیمت طلا, محاسبه آنلاین طلا با اجرت, حباب سنج سکه, حباب‌سنج سکه, نیم‌سکه, ربع‌سکه, قیمت طلا ۱۸ عیار')
  ...
  "@@graph": [
    {
      ...
      "alternateName": [
        "ماشین‌حساب طلا",
        "محاسبه‌گر قیمت طلا فروشی",
        "حباب‌سنج سکه",
        "حسابگر طلا و مسکوکات"
      ],
      ...
      "description": "ابزار رایگان و تعاملی محاسبه فاکتور طلا با اجرت، سود ۷ درصد مغازه طلا فروشی، مالیات ارزش افزوده و حباب‌سنج انواع سکه."
    },
    {
      "@@type": "BreadcrumbList",
      "itemListElement": [
