...
@section('title', 'ماشین‌حساب آنلاین طلا با اجرت و حباب سکه | نرخ زنده | طلالایو')
@section('meta_description', 'محاسبه آنلاین و دقیق قیمت طلا بر اساس آخرین فرمول مصوب اتحادیه طلا و قانون جدید مالیات. محاسبه آنی حباب سکه امامی، بهار، نیم و ربع با نرخ‌های لحظه‌ای طلالایو.')
@section('meta_keywords', 'ماشین حساب طلا, فرمول محاسبه قیمت طلا, محاسبه آنلاین طلا با اجرت, حباب سنج سکه, محاسبه حباب سکه امامی, قیمت روز طلا ۱۸ عیار')
...
<script type="application/ld+json">
{
  ...
  "@@graph": [
    {
      "@@type": "WebApplication",
      "name": "ماشین‌حساب آنلاین قیمت طلا و حباب سکه طلالایو",
      ...
      "description": "ابزار رایگان و تعاملی محاسبه فاکتور طلا با اجرت، سود ۷ درصد، مالیات ارزش افزوده و حباب‌سنج انواع سکه."
    },
    {
      "@@type": "BreadcrumbList",
      "itemListElement": [
...
<div class="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-16" 
    ...
    <div class="glass-panel p-8 sm:p-12 rounded-3xl border border-slate-200 dark:border-slate-800 space-y-6 text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
        <h2 class="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">راهنمای محاسبه قیمت طلا در طلافروشی‌ها</h2>
        <p>
            شاید برای شما هم پیش آمده باشد که هنگام خرید یک انگشتر یا سرویس طلا، قیمت نهایی فاکتور با ضرب ساده وزن در نرخ روز متفاوت باشد. در بازار طلای ایران، ۴ عامل کلیدی قیمت نهایی را مشخص می‌کنند:
        </p>
        <ol class="list-decimal list-inside space-y-2 text-slate-700 dark:text-slate-300">
            ...
            <li><strong>سود طلافروش:</strong> طبق آیین‌نامه رسمی اتحادیه صنف طلا و جواهر، سود قانونی طلافروشی معادل ۷ درصد از جمع طلای خام و اجرت می‌باشد.</li>
            <li><strong>مالیات بر ارزش افزوده (VAT):</strong> مطابق ماده ۲۶ قانون مالیات بر ارزش افزوده مصوب دی‌ماه ۱۴۰۰، طلای خام از مالیات معاف است و مالیات ۹ درصدی تنها به جمع اجرت ساخت و سود فروشنده تعلق می‌گیرد.</li>
        </ol>
    </div>
