...
@section('title', 'ماشین حساب محاسبه آنلاین قیمت طلا با اجرت، سود و مالیات ۱۴۰۴ | طلالایو')
@section('meta_description', 'ابزار دقیق و آنلاین محاسبه فاکتور طلا بر اساس آخرین فرمول مصوب اتحادیه طلا و جواهر. محاسبه اجرت، سود قانونی ۷ درصد و مالیات ۹ درصد روی اجرت با نرخ لحظه‌ای طلالایو.')
@section('meta_keywords', 'محاسبه آنلاین قیمت طلا, فرمول طلا با اجرت, محاسبه مالیات طلا ۱۴۰۴, سود طلافروشی, فاکتور طلا آنلاین')
...
<script type="application/ld+json">
{
  ...
  "@@graph": [
    {
      "@@type": "WebApplication",
      "name": "ماشین حساب آنلاین قیمت طلا با اجرت و مالیات",
      "url": "https://talalive.ir/tools/gold-price-calculator",
      "applicationCategory": "FinanceApplication",
      "operatingSystem": "All",
      "description": "ابزار محاسبه فاکتور خرید طلا با احتساب وزن، اجرت ساخت، سود ۷ درصد و مالیات ۹ درصد طبق آخرین مصوبه اتحادیه طلا و جواهر."
    },
    {
      "@@type": "BreadcrumbList",
      "itemListElement": [
