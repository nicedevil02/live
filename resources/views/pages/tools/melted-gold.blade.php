...
@section('meta_description', 'ابزار آنلاین و تخصصی محاسبه طلای آب‌شده برای تبدیل وزن و عیار انگ ری‌گیری به وزن شرطی ۷۵۰ با نرخ لحظه ای طلالایو.')
...
<div class="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto space-y-12">
    ...
    <div class="glass-panel p-6 sm:p-10 rounded-3xl border border-slate-200 dark:border-slate-800 space-y-4 text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
        ...
        <p>
            <strong>طلای آب‌شده</strong> به طلای ذوب‌شده از زیورآلات مستعمل یا شمش‌های کارگاهی گفته می‌شود که در آزمایشگاه ری‌گیری عیارسنجی شده و کد انگ روی آن حک می‌شود.
        </p>
        <p>
