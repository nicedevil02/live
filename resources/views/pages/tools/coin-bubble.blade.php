...
@section('meta_description', 'حباب سنج آنلاین سکه طلالایو: محاسبه لحظه ای ارزش ذاتی و درصد حباب سکه امامی، سکه بهار آزادی، نیم سکه، ربع سکه و سکه گرمی با فرمول بانک مرکزی و تابلوی طلا.')
  ...
  "@@graph": [
    {
      ...
      "operatingSystem": "All",
      "description": "ابزار آنلاین محاسبه لحظه ای ارزش ذاتی و درصد حباب سکه امامی، بهار آزادی، نیم سکه و ربع سکه بر مبنای انس جهانی طلا و نرخ ارز."
    },
    {
      "@@type": "BreadcrumbList",
      "itemListElement": [
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@@type": "Question",
          "name": "تفاوت حباب سکه بهار آزادی با سکه امامی چیست؟",
          "acceptedAnswer": {
            "@@type": "Answer",
    ...
    <div class="glass-panel p-6 sm:p-10 rounded-3xl border border-slate-200 dark:border-slate-800 space-y-6">
        ...
        <div class="space-y-4 text-xs sm:text-sm text-slate-600 dark:text-slate-300">
            <div class="p-5 rounded-2xl bg-white/60 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800/80 space-y-2">
                <h4 class="font-bold text-slate-900 dark:text-white text-sm">تفاوت حباب سکه بهار آزادی با سکه امامی چیست؟</h4>
                <p class="leading-relaxed">
                    وزن و عیار هر دو سکه دقیقاً یکسان است (۸.۱۳۳ گرم طلای عیار ۹۰۰). تفاوت قیمت و حباب ناشی از تقاضای بالاتر معامله‌گران در بازار برای سکه امامی (طرح جدید) نسبت به سکه تمام بهار آزادی (طرح قدیم) می‌باشد.
                </p>
            </div>
